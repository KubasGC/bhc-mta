...
function renderDx()
	...
	if(state == "hiding") then
		local progress = (getTickCount() - tick) / 1000
		y, _, _ = interpolateBetween(y, 0, 0, 0, 0, 0, progress, "Linear")
	...
	dxDrawImage(0.24743777452416 * screenWidth, y, 0.46632503660322 * screenWidth, 0.063802083333333 * screenHeight, "kill.png", 0, 0, 0, tocolor(255, 255, 255, 255), true)
end
